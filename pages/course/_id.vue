        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            <h2 class="hLh30 txtOf mt15">
              <span class="c-fff fsize24">{{courseWebVo.subjectLevelTwo}}</span>
            </h2>
            ...
            <div class="i-box">
              <article class="ml10 mr10 pt20">
                <div class="mt50">
                  ...
                  <section class="mt20">
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu2" class="lh-menu mt10 mr10">
                        <ul>
                          <!-- 文件目录 -->
                          <li class="lh-menu-stair" v-for="chapter in chapterVideo" :key="chapter.id">
                            <a href="javascript: void(0)" :title="chapter.title" class="current-1">
...
<!--                    <section class="mt20">-->
<!--                      <div class="lh-menu-wrap">-->
<!--                        &lt;!&ndash; 课程简介 TODO &ndash;&gt;-->
<!--                        <el-form-item label="课程简介">-->
<!--                          &lt;!&ndash;        <el-input v-model="courseInfo.description" placeholder=" 示例"/>&ndash;&gt;-->
<!--                          <tinymce v-model="courseInfo.description" :height="300" class="tinymce-container"></tinymce>-->
<!--                        </el-form-item>-->
    ...
    export default {
        asyncData({params,error}){
            return courseApi.getCourseInfo(params.id).then(res=>{
                return {courseWebVo:res.data.data.courseWebVo,chapterVideo:res.data.data.chapterVideo}
            })
        },
        components:{
            // Tinymce
