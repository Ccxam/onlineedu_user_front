  ...
  <div>
    ...
    <div v-swiper:mySwiper="swiperOption">
      <div class="swiper-wrapper">
        <div class="swiper-slide" style="background: #040B1B;" v-for="item in bannerList" :key="item.id">
                  ...
                  <div class="cc-l-wrap">
                    ...
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        <i class="c-fff fsize12 f-fA">{{course.price>0?"收费":"免费"}}</i>
                      </span>
    ...
    export default {
        ...
        methods:{
            ...
            getListTeacherCourse(){
                index.getListCourseTeacher().then(res=>{
                    console.log(res.data)
                    this.teacherList=res.data.data.eduTeachers
                    this.courseList = res.data.data.eduLists
                })
            }
